...
void setup() {
  ...
  Blue = loadImage("./Asset/gablam20-ITGM220-01-Assignment3-Asset_Blue.jpg");
  Red = loadImage("./Asset/gablam20-ITGM220-01-Assignment3-Asset_Red.jpg");
  Brown = loadImage("./Asset/gablam20-ITGM220-01-Assignment3-Asset_BBrown.jpg");
  Green = loadImage("./Asset/gablam20-ITGM220-01-Assignment3-Asset_Green.jpg");
...
void draw() {
  ...
  //drawTunnel();
  if (System.currentTimeMillis() - currentTime >= 10000 && System.currentTimeMillis() - currentTime < 13000) {
    image(TrainInterior, 0, 0, 450, 975);
    ...
    if (!excuted) {    
      ...
      case "BlueColor":
        {
          image(Blue, x, 183, 550, 500);
          break;
        } 
      case "RedColor":
        {
          image(Red, x, 183, 550, 500);
          break;
        } 
      case "BrownColor":
        {
          image(Brown, x, 183, 550, 500);
          break;
        } 
      case "GreenColor":
        {
          image(Green, x, 183, 550, 500);
          break;
        }
      }
      ...
      textSize(15);
      fill(#000000);
      text(options.get(0), 122, 815);
      text(options.get(1), 325, 815);
      text(options.get(2), 122, 905);
      text(options.get(3), 325, 905);
      textAlign(CENTER);
      popMatrix();
    }
    if (key == 'a') {
